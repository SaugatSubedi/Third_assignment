...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (studentsList.isEmpty()) {
            studentsList.add(new Students("Saugat Subedi", "male", "Nepal, Lalitpur", 21));
            studentsList.add(new Students("Manisha Kc", "female", "Nepal, Ktm", 22));
            studentsList.add(new Students("Ansih Thakur", "other", "Nepal, Ktm", 23));
        }
